pipeline {
    ...
    environment {
        ...
        ECR_REPO = '718125551687.dkr.ecr.ap-south-1.amazonaws.com/my_pvt_repo' // Your ECR repository URI
    ...
    stages {
        stage('SCM checkout') {
            steps {
                script {
                    git branch: 'main', credentialsId: 'git-cred', url: 'https://github.com/NithyaMKH/K8s_Real_Project.git'
                }
            }
        }
